#!/usr/bin/env python3
"""
Cost calculator checker and validator
Run this script to verify your cost calculation settings are properly configured
"""
...
def main():
    ...
    if cost_calculator.validate_configuration():
