...
class GeminiEngine(BaseLLMEngine):
    ...
    def __init__(self, model_name: str = None, api_key: str = None):
        ...
        # Gemini pricing from settings (in USD per 1K tokens)
        self.input_cost_per_1k = settings.GEMINI_INPUT_COST_PER_1K
        self.output_cost_per_1k = settings.GEMINI_OUTPUT_COST_PER_1K
    ...
    def generate_response(self, prompt: str, **kwargs) -> str:
        ...
        try:
            ...
            logger.info(
                f"Request cost: ${request_cost['total_cost']:.6f}, "
...
Please provide a helpful response. If you need to use any tools, mention which tool you would use and why, but focus on providing a direct answer to the user's question."""
    ...
    def _calculate_request_cost(self, prompt: str, response) -> Dict[str, Any]:
        """
        Calculate cost for a single request using cost_calculator
        ...
        try:
            ...
            # Calculate costs using cost_calculator
